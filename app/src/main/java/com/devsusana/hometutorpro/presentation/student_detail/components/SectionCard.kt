...
/**
 * Reusable card component for displaying sections with an icon and title.
 */
@Composable
fun SectionCard(
    title: String,
...
private fun SectionCardPreview() {
    HomeTutorProTheme {
        SectionCard(
            ...
            Text("This is the content area of the section card.")
            Spacer(modifier = Modifier.height(8.dp))
            Text("You can add any composable content here.")
        }
    }
}
