package com.devsusana.hometutorpro.data.local.migrations

import androidx.room.migration.Migration
import androidx.sqlite.db.SupportSQLiteDatabase

/**
 * Declares all database migrations for Room to keep the AppDatabase class clean and maintainable.
 */
    ...
    val MIGRATION_6_7 = object : Migration(6, 7) {
        override fun migrate(database: SupportSQLiteDatabase) {
            ...
            database.execSQL("""
                ...
                SELECT id, cloudId, studentId, originalScheduleId, exceptionDate, reason, isCancelled, newStartTime, newEndTime, newDayOfWeek,
                CASE newDayOfWeek 
                    WHEN 'MONDAY' THEN 1 
                    WHEN 'TUESDAY' THEN 2 
                    WHEN 'WEDNESDAY' THEN 3 
